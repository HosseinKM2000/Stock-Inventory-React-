...
const messages: Record<string, string> = {
  ...
  PACK_SIZE_REQUIRED: "برای محصول بسته‌ای، تعداد صحیح واحد در هر بسته الزامی است.",
  CATALOG_PACKAGING_ADMIN_CONTROLLED: "بسته‌بندی محصول کاتالوگی فقط توسط مدیر کاتالوگ قابل تغییر است.",
